    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-center">
                <Link href="/blog" className="py-2 px-24 text-bright-blue text-lg sm:text-xl lg:text-2xl font-semibold rounded-full bg-white hover:bg-icy-blue shadow hover:shadow-md hover:scale-105 transition duration-200">ดูบทความทั้งหมด</Link>
            </div>
        </div>
    );
}
