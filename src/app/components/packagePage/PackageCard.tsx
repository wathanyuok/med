    ...
    return (
        <div className="flex flex-col gap-4 rounded-2xl shadow-sm transition h-full bg-white">
            ...
            <div className="space-y-4 px-8">
                <div>
                    <h4 className="text-xl font-semibold text-neutral-800 line-clamp-2 mb-2">
                        {title}
                    </h4>
                    <p className="text-md text-neutral-600 line-clamp-2">
                        {sub_title}
                    </p>
                </div>

                {/* ราคา */}
                <div className="flex items-start justify-start gap-8 py-6">
                    <div>
