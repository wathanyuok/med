...
import ProductGallery, { GalleryImage } from "@/app/components/ui/ProductGallery";
import PackageCard from "@/app/components/packagePage/PackageCard";
import { Landmark,HandCoins, BanknoteArrowDown, CreditCard } from "lucide-react";
      ...
      <div className="py-40 container mx-auto px-4 md:px-12 lg:px-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col gap-8 items-start">
                  {/* Title */}
                  <div>
                      <p className="text-sm text-neutral-500">{packageData.category}</p>
