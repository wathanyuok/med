...
import ClearCArdHero from "@/app/assets/images/department_eye/department_eye_hero_clear_card.png"
import Item1 from "@/app/assets/images/department_eye/department_eye_item_1.png"
import Item2 from "@/app/assets/images/department_eye/department_eye_item_2.png"
import Item3 from "@/app/assets/images/department_eye/department_eye_item_3.png"
import Item4 from "@/app/assets/images/department_eye/department_eye_item_4.png"
import Hero1 from "@/app/assets/images/department_eye/department_eye_hero_1.png"
import Hero2 from "@/app/assets/images/department_eye/department_eye_hero_2.png"
import Hero3 from "@/app/assets/images/department_eye/department_eye_hero_3.png"
import Image from "next/image";
import ClearCardSection from "@/app/components/departmentPage/ClearCardSection";
import { departmentEyeClearCardData } from "@/app/utils/mockData/department";
        ...
        <div className="py-40 ">
                ...
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 py-8">
                    ...
                    <div className="text-center sm:text-left">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-neutral-800">
                            Ophthalmology and Vision Care Center
                        </h1>
                        <h2 className="text-base sm:text-lg lg:text-xl text-neutral-800 mt-2">
                            ศาสตร์แห่งการดูแลดวงตา เพื่อการมองเห็นอย่างมีคุณภาพในทุกช่วงวัย <br />
                            The science of vision care—for clarity and quality at every stage of life.
                        </h2>
                    </div>
            ...
            <div>
                <ClearCardSection
                    ...
                    cardItems={departmentEyeClearCardData}
                    reverse={true}
                />
            </div>
